    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full">
        <div className="text-center">
          {/* 图标 */}
          <div className="inline-flex items-center justify-center w-16 h-16 bg-linuxdo-100 text-linuxdo-600 rounded-full mb-6">
            <Container size={32} />
          </div>
          ...
          {/* 当前状态 */}
          <div className="flex items-center justify-center space-x-2 text-linuxdo-600">
          ...
          <div className="mt-8 text-left">
            <h3 className="text-sm font-medium text-gray-900 mb-3">创建步骤：</h3>
